...
<template>
  <div @click.stop class="relative w-full h-full flex items-center justify-center bg-black rounded overflow-hidden select-none group/player">
    ...
    <a
      ...
      @click.stop
      class="absolute top-2.5 right-2.5 z-30 opacity-0 group-hover/player:opacity-100 transition-opacity bg-black/75 hover:bg-purple-600/90 text-white text-[11px] font-mono px-2.5 py-1 rounded-lg border border-white/20 flex items-center gap-1.5"
    >
