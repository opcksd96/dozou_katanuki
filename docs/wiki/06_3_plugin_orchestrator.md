# 6.3 Job & Process Orchestrator（管理コンソール向け非同期ジョブ制御）
...
**Navigation** : [← 前の節: 6.2 Data & Skin Decorator](06_2_data_decorator) | [📚 目次 (Home)](Home) | [次の章: 第7章 ドライバー層（Core Backend & Data Abstraction） →](07_robust_backend_driver_and_api_v4)
