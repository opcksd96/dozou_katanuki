[[← 前の章: 第3章：実装規約・制約原則|03_implementation_principles_and_constraints]] | [[📚 目次 (Home)|Home]] | [[次の章: 第5章：プレゼンテーション層概論（Foolish Frontend & Vue 3） →|05_foolish_frontend_and_declarative_ui_v4]]
