# 6.2 Data & Skin Decorator（描画データ装飾とスキン配信）
...
**Navigation** : [← 前の節: 6.1 Middleware Core Components](06_1_middleware_core) | [📚 目次 (Home)](Home) | [次の節: 6.3 Job & Process Orchestrator →](06_3_plugin_orchestrator)
