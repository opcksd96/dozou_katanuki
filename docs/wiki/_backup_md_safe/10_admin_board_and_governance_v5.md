...
**Navigation** : [← 前の章: 第2編第2章：プラグインアーキテクチャとサイドカー](part2_02_plugin_architecture) | [📚 目次 (Home)](Home) | [次の章: 第11章：参考資料・技術文献・型定義カタログ →](11_references_and_literature)
