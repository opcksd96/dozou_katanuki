# 第3編 第4章：ドライバー層（Core Backend & Data Abstraction）
...
**Navigation** : [← 前の章: 第3編第3章 ミドルウェア層（Intelligent Hub & Middleware Architecture）](part3_03_0_middleware_index) | [📚 目次 (Home)](Home) | [次の章: 第1編第3章：ローカルストレージ保全とメディアポリシー →](part1_03_storage_persistence)
...
**Navigation** : [← 前の章: 第3編第3章：コンテンツディスパッチャー層（Middleware Hub & Proxy）](part3_03_0_middleware_index) | [📚 目次 (Home)](Home) | [次の章: 第1編第3章：ローカルストレージ保全とメディアポリシー →](part1_03_storage_persistence)