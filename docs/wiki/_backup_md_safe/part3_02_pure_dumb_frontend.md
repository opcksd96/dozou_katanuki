# 第3編 第2章：フロントエンド層概論（Foolish Frontend & 宣言型UI）
...
**Navigation** : [← 前の章: 第3編第1章：データベース設計と仮想ストレージプール](part3_01_database_design) | [📚 目次 (Home)](Home) | [次の章: 第3編第3章：ミドルウェア層（Middleware Hub & Proxy） →](part3_03_0_middleware_index)
...
**Navigation** : [← 前の章: 第3編第1章：データベース設計と仮想ストレージプール](part3_01_database_design) | [📚 目次 (Home)](Home) | [次の章: 第3編第3章 ミドルウェア層（Intelligent Hub & Middleware Architecture） →](part3_03_0_middleware_index)
