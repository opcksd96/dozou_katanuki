[[← 前の章: 第2章：外部サービスの概要とサルベージ技術|part1_02_external_services]] | [[📚 目次 (Home)|Home]] | [[次の章: 第3編第1章：データベース設計と仮想ストレージプール →|part3_01_database_design]]

### 第1編 第4章：実装規約・制約原則（宣言型UI・UDF・AI駆動開発と開発者リファレンス）
