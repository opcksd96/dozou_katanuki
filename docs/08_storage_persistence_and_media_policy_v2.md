...
**Navigation** : [← 前の章: 第7章：ドライバー層（Core Backend API）](07_robust_backend_driver_and_api_v4.md) | [📚 目次 (Home)](README.md) | [次の章: 第9章：プラグインアーキテクチャとサイドカー →](09_plugin_architecture_and_sidecar_v3.md)
