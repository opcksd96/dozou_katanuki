### 第10章：システム管理・設定・保守（Admin & Governance）
...
**Navigation** : [← 前の章: 第9章：プラグインアーキテクチャとサイドカー](09_plugin_architecture_and_sidecar_v3.md) | [📚 目次 (Home)](README.md) | [次の章: 第11章：参考資料・技術文献・型定義カタログ →](11_references_and_literature.md)
...
#### 10.3 Admin Board と Scraper管理画面仕様 (Settings UI)
...
#### 10.4 二重化バックアップ設計 (Dual-Source Disaster Recovery)
...
#### 10.7 cron-likeワーカースケジューラーと Broadcast フレームワーク
