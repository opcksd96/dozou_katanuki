...
func (s *BroadcastService) startServerLocked() error {
	...
	mux.HandleFunc("/api/admin/pipeline/media-tasks", s.handlePipelineMediaTasksAPI)
	...
	mux.HandleFunc("/api/admin/audit/purge-files", s.handleAuditPurgeFilesAPI)
	mux.HandleFunc("/api/admin/audit/purge-db", s.handleAuditPurgeDBAPI)
	mux.HandleFunc("/api/admin/audit/rollback", s.handleAuditRollbackAPI)
	mux.HandleFunc("/api/admin/audit/can-rollback", s.handleAuditCanRollbackAPI)
