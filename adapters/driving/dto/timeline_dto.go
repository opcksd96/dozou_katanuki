// adapters/driving/dto/timeline_dto.go (100行以下 - SPEC-PRINCIPLE-001)
package dto

// RenderContent は投稿コンテンツの描画用モデルです
...
// RenderAuthor は投稿者プロフィールの描画用モデルです
...
// RenderMetrics はエンゲージメント指標の描画用モデルです
...
// RenderTree はフロントエンド描画用の完成データ構造体（タイムライン要素）です
