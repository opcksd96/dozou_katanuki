...
func (a *App) BatchTrashArticles(ids []string, trashedBy, reason string) error {
	...
	if a.Ctx != nil {
		runtime.EventsEmit(a.Ctx, "article:batch_trashed", map[string]interface{}{
...
func (a *App) BatchRestoreArticles(ids []string) error {
	...
	if a.Ctx != nil { runtime.EventsEmit(a.Ctx, "article:batch_restored", map[string]interface{}{"ids": ids}) }
	return nil
}
...
func (a *App) BatchResetTranslations(ids []string) error {
	...
	if a.Ctx != nil { runtime.EventsEmit(a.Ctx, "article:batch_reset_translations", map[string]interface{}{"ids": ids}) }
	return nil
}
