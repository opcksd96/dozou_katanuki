...
type Article struct {
	...
	MediaExcluded    []MediaExcluded `gorm:"foreignKey:ArticleID;references:ID;" json:"media_excluded,omitempty"`
	...
	RetweetedArticle *Article        `gorm:"foreignKey:ReplyToID;references:ID;" json:"retweeted_article,omitempty"`
}
